 ...
 */
export default function RatedTorqueNmFilter({ filters, onFilterChange }) {
    ...
    return (
        <Row className="mb-3 align-items-center">
            ...
            <Col md={4}>
                <Form.Label>Minimum Torque Nm:</Form.Label>
            </Col>
            ...
            <Col md={8}>
                <Form.Control
                    type="number" 
                    name="ratedTorqueNm" // Name matches the state key
                    placeholder="Min Torque"
                    value={filters.ratedTorqueNm || ''} 
