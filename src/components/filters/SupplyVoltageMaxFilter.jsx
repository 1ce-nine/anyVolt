...
/**
 * Supply Voltage Maximum Filter (V)
 ...
 */
export default function SupplyVoltageMaxFilter({ value, onChange }) {
    return (
        <Row className="mb-3 align-items-center">
            ...
            <Col md={8}> 
                <Form.Control
                    type="number"
                    name="supplyVoltageMaxV" // Matches state key
                    placeholder="Max Supply V"
